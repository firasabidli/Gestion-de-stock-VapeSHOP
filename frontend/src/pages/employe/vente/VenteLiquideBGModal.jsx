...
const VenteLiquideBGModal = ({ show, liquides, onHide, OnVente }) => {
  ...
  axios.post('http://localhost:5000/api/ventes', venteData, {
    withCredentials: true, // Envoie automatiquement le cookie sécurisé
  })
  .then(() => {
...
export default VenteLiquideBGModal;
