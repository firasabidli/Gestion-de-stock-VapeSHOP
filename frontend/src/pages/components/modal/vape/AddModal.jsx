...
const AddModal = ({ show, handleClose, OnAdd }) => {
  ...
  try {
    ...
    await axios.post('https://gestion-de-stock-vape-shop-api.vercel.app/api/vapes', form, {
    ...
    console.error('Erreur création vape', err);
  }
};
  ...
  return (
    <Modal show={show} onHide={handleClose} centered contentClassName="dark-modal"  >
      <Modal.Header closeButton>
        <Modal.Title>Ajouter une Vape</Modal.Title>
      </Modal.Header>
      <Modal.Body >
